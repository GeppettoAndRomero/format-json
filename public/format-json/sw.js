...
const CACHE_NAME = 'format-json-v1';
const RUNTIME_CACHE = 'format-json-runtime';

// キャッシュするリソース（静的アセット）
const PRECACHE_URLS = [
  '/format-json/',
  '/format-json/manifest.json',
  '/format-json/icon-192.png',
  '/format-json/icon-512.png',
];
...
function isStaticAsset(pathname) {
  ...
  return staticExtensions.some(ext => pathname.endsWith(ext)) || pathname === '/format-json/manifest.json';
}
